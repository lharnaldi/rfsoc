...
cell labdpr:user:axis_decimator:1.0 dcmtr_0 {
  AXIS_TDATA_WIDTH 32
  CNTR_WIDTH 16
} {
...
cell labdpr:user:axi_axis_writer:1.0 writer_1 {
  AXI_DATA_WIDTH 32
} {
  aclk ps_0/FCLK_CLK0
  aresetn rst_0/peripheral_aresetn
...
# Create axis_zeroer
cell labdpr:user:axis_zeroer:1.0 zeroer_0 {
  AXIS_TDATA_WIDTH 32
} {
...
cell labdpr:user:axis_interpolator:1.0 inter_0 {
  AXIS_TDATA_WIDTH 32
  CNTR_WIDTH 16
} {
