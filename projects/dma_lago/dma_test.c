...
int main() {
    ...
    unsigned int* virtual_destination_address = mmap(NULL, 1024*sysconf(_SC_PAGESIZE), PROT_READ | PROT_WRITE, MAP_SHARED, dh, 0x0f000000); // Memory map destination address
