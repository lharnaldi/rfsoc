...
cell labdpr:user:axis_gpio_reader:1.0 gpio_0 {
  AXIS_TDATA_WIDTH 8
} {
...
cell labdpr:user:axis_variable:1.0 rate_0 {
  AXIS_TDATA_WIDTH 16
} {
...
# Create axis_variable
cell labdpr:user:axis_variable:1.0 rate_1 {
  AXIS_TDATA_WIDTH 16
} {
  cfg_data slice_8/Dout
  aclk ps_0/FCLK_CLK0
...
# Create axis_trigger
cell labdpr:user:axis_trigger:1.0 trig_0 {
  AXIS_TDATA_WIDTH 8
...
cell labdpr:user:axis_oscilloscope:1.0 scope_0 {
  AXIS_TDATA_WIDTH 32
  CNTR_WIDTH 23
} {
